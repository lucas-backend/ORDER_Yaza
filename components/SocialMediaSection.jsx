    ...
    >
      ...
      >
        ...
        <div className="lg:col-span-5 flex flex-col justify-center h-full">
          <p
            className="text-sm font-medium tracking-widest uppercase opacity-70 mb-6"
          >
            Portfolio - Social Media
          </p>
          <h2
            className="text-6xl md:text-8xl font-display text-[#0F1035] uppercase tracking-tighter mb-8 leading-none"
          >
            NUEVA FACE
          </h2>
          <p
            className="text-base md:text-lg leading-relaxed font-light opacity-80 mb-8"
          >
