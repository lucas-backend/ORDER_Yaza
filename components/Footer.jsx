export default function Footer() {
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-20 flex flex-col items-center justify-center h-full text-center">
        ...
        <p className="font-body text-gray-800 text-xl md:text-2xl font-light tracking-widest mb-20 drop-shadow-md">
          See you soon
        </p>

        <div className="w-full flex justify-between items-center text-primary mt-auto border-t border-primary/20 pt-8 uppercase font-condensed tracking-widest text-xs md:text-sm">
          <div className="hover:text-blue-500 transition cursor-pointer">
            Back to top
          </div>
          <div className="flex items-center gap-2">
            <span>&copy; 2026 Yaza Nurzahira</span>
          </div>
